...
export class CardMySuffixService {
    ...
    create(card: CardMySuffix): Observable<CardMySuffix> {
    ...
    update(card: CardMySuffix): Observable<CardMySuffix> {
        const copy = this.convert(card);
    ...
    find(id: number): Observable<CardMySuffix> {
     ...
     */
    private convertItemFromServer(json: any): CardMySuffix {
        const entity: CardMySuffix = Object.assign(new CardMySuffix(), json);
        return entity;
    }
